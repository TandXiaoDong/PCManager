...
namespace ShikuIM.UserControls.Message
{
    ...
    public partial class PhotoView : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //this.Topmost = true;
            /*
            this.Left = SystemParameters.PrimaryScreenWidth * 0.15;
            this.Top = SystemParameters.PrimaryScreenHeight * 0.15;
            */
            this.Width = db_Width;
        ...
        /// 需实现单例的对象
        /// </summary>
        private static PhotoView thisPhotoView { get; set; }

        #region 单例方法
        public PhotoView getPhotoView(string localPath)
        {
            if (thisPhotoView == null)
            {
                thisPhotoView = new PhotoView();
            }
